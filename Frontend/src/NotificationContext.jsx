...
const NotificationContainer = ({ notifications, onRemove }) => {
  ...
  const getNotificationStyles = (type) => {
    const baseStyles = "flex items-center justify-between p-4 mb-3 rounded-lg shadow-lg border-l-4 max-w-md w-full transform transition-all duration-300 ease-in-out";
