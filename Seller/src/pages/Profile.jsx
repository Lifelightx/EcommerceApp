...
const ProfilePage = () => {
  const { url, sellerToken, user, setUser } = useContext(StoreContext);
                      ...
                      <form onSubmit={handleAddressSubmit} className="space-y-4">
                        ...
                        <div>
                          ...
                          <textarea
                            ...
                            className="w-full px-3 py-1 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-red-500"
                            rows="3"
                            required
                          />
                        </div>
